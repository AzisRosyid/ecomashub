...
class StoreController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminStore')->with('message', 'Toko telah berhasil dibuat!');
    }
    ...
    public function update(Request $request, Store $store)
    {
        ...
        return redirect()->route('adminStore')->with('message', 'Toko telah berhasil diperbarui!');
    }
    ...
    public function destroy(Store $store)
    {
        ...
        return redirect()->route('adminStore')->with('message', 'Toko telah berhasil dihapus!');
    }
}
