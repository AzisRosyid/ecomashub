...
class WasteController extends Controller
{
    ...
    public function index(CustomRequest $request)
    {
        ...
        return Method::view('admin.eco-friendly.waste.index', compact('route', 'acc', 'wastes', 'pick', 'page', 'total', 'pages', 'units', 'pickUnit', 'pageUnit', 'totalUnit', 'pageUnits'));
    }
    ...
    public function create()
    {
        ...
        return Method::view('admin.eco-friendly.waste.create', compact('route', 'acc', 'units', 'products', 'types'));
    }
    ...
    public function edit(Waste $waste)
    {
        ...
        return Method::view('admin.eco-friendly.waste.edit', compact('route', 'acc', 'units', 'products', 'types', 'waste'));
    }
