        ...
        <div class="py-3 px-2 w-full fixed bottom-0 border-t">
            <div class="flex gap-2 items-end max-w-full">
                ...
                <div class="flex items-center justify-center">
                    <textarea id="user-input" class="w-[17rem] h-auto max-h-48 overflow-auto border rounded-md outline-none resize-none p-2"
                        rows="1" placeholder="Tulis pertanyaan Anda di sini..."></textarea>
                </div>
                <div>
                    <a id="sendMessage"
