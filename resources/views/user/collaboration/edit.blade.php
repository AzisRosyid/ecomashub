...
@section('content')
    ...
    <div class="py-8 bg-gray-50 justify-start items-start w-full border-l">
        <a href="{{ route('userCollaboration') }}" class="mx-2 sm:mx-10 text-green-600 text-sm font-medium flex">
        ...
        <!-- body -->
        <form action="{{ route('userCollaborationUpdate', $collaboration) }}" method="POST"
            ...
            <div class="flex justify-end mt-4">
                <a href="{{ route('userCollaboration') }}"
