    ...
    <div class="py-4 sm:py-8 bg-gray-50 justify-start items-start w-full border-l">
        ...
        <div class="flex mx-4 sm:mx-10 justify-between border-b pb-4">
            ...
            <div class="justify-between hidden lg:flex">
                <form action="{{ route('userDebtCreate') }}" class="">
            ...
            <div class="flex justify-between">
                <div class="flex p-2 w-1/2 sm:w-auto bg-white rounded-md border border-gray-400">
                    ...
                    <input id="search" type="text" class="outline-none ms-2 w-full" name="search"
                        value="{{ request()->input('search') }}" placeholder="Cari hutang">
                </div>
        ...
        <div class="border rounded-lg mt-4 py-3 sm:mx-10">
            <div class="flex justify-between px-6">
                <div class="flex gap-2">
                    <p class="text-zinc-700 text-lg font-semibold font-fredokaBold leading-9">Semua Hutang</p>
                ...
                <table class="font-fredokaRegular text-zinc-700 w-full mt-2 text-sm font-normal">
                    ...
                    <head class="">
                        <tr>
                            ...
                            <th class="bg-gray-200 py-3 text-start px-3">Bunga</th>
                    ...
                    <body>
                        @foreach ($debts as $index => $st)
                            <tr class="border-b">
                                ...
                                <td class="py-3 text-start px-3">{{ $st->interest * 100 }}%</td>
                                <td class="py-3 text-start px-3">{{ $st->formatted_date_start }} -
                                    {{ $st->formatted_date_end }}</td>
                                <td class="py-3 text-start px-3 min-w-[150px]">
                                    <div class="flex">
                                        <a href="{{ route('userDebtEdit', $st) }}"
                                        ...
                                        <form action="{{ route('userDebtDestroy', $st) }}" method="POST"
                                            class="px-1">
                                            @method('delete')
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <button
...
@section('filter')
    ...
    <div class="h-full w-80 bg-white py-4 px-4 fixed z-20 top-0 right-0 hidden" id="menuFilter">
        ...
        <div class="border-b">
            <label for="hutang" class="block">Tipe hutang</label>
            <select name="hutang" id="hutang" class="w-full outline-none border p-2 rounded-lg mt-2 mb-4">
        ...
        <div class="border-b mt-4">
            <label for="harga" class="block">Dana hutang</label>
        ...
        <div class="border-b mt-4">
            <label for="kegiatan1" class="block">Tipe hutang</label>
        ...
        <div class="border-b mt-4">
            <label for="pelaksanaan" class="block">Pelaksanaan hutang</label>
    ...
    <div id="isiDetail"
        ...
        <div class="font-fredokaRegular pt-4">
            <p class="text-xl font-fredokaBold">Nama Hutang</p>
