...
@section('content')
    ...
    <div class="py-8 bg-gray-50 justify-start items-start w-full border-l">
        ...
        <div class="flex mx-2 sm:mx-10 justify-between border-b pb-4 mt-4">
            <div>
                <p class="text-zinc-700 text-[28px] font-semibold font-fredokaBold leading-9">Tambah Hutang</p>
        ...
        <form action="{{ route('userDebtStore') }}" method="POST" class="mt-6 sm:mx-10 mx-2 font-fredokaRegular">
            ...
            <div class="border-b sm:flex">
                ...
                <input type="text" name="name" id="judulHutang"
                    ...
                    placeholder="Nama hutang" value="{{ old('name') }}" required>
            </div>
