    ...
    <div class="py-4 sm:py-8 bg-gray-50 justify-start items-start w-full border-l">
        ...
        <div class="flex mx-4 sm:mx-10 justify-between border-b pb-4">
            ...
            <div class="justify-between hidden lg:flex">
                <form action="{{ route('userExpenseCreate') }}" class="">
                ...
                <a href="{{ route('userExpenseCreate') }}"
                        ...
                        @foreach ($expenses as $index => $st)
                            <tr class="border-b">
                                ...
                                <td class="py-3 text-start px-3 min-w-[150px]">
                                    <div class="flex">
                                        <a href="{{ route('userExpenseEdit', $st) }}"
                                        ...
                                        <form action="{{ route('userExpenseDestroy', $st) }}" method="POST"
                                            class="px-1">
                                            @method('delete')
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <button
