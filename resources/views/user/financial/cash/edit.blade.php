...
@section('content')
    ...
    <div class="py-8 bg-gray-50 justify-start items-start w-full border-l">
        <a href="{{ route('userCash') }}" class="mx-2 sm:mx-10 text-green-600 text-sm font-medium flex">
        ...
        <!-- body -->
        <form action="{{ route('userCashUpdate', $cash) }}" method="POST" class="mt-6 sm:mx-10 mx-2 font-fredokaRegular">
            @method('put')
            @csrf
