...
@section('content')
    ...
    <div class="py-8 bg-gray-50 justify-start items-start w-full border-l">
        <a href="{{ route('userOrder') }}" class="mx-2 sm:mx-10 text-green-600 text-sm font-medium flex">
        ...
        <div class="flex mx-2 sm:mx-10 justify-between border-b pb-4 mt-4">
            <div>
                <p class="text-zinc-700 text-[28px] font-semibold font-fredokaBold leading-9">Tambah Pesanan</p>
...
@include('user.alert.error')
        ...
        <!-- body -->
        <form action="{{ route('userOrderStore') }}" method="POST" class="mt-6 sm:mx-10 mx-2 font-fredokaRegular">
            @csrf
            <div class="border-b mt-3 sm:flex">
                ...
                <input type="text" name="name" id="nama"
                    ...
                    placeholder="Nama pemesan" value="{{ old('name') }}" required>
            </div>
            <div class="border-b mt-3 sm:flex">
