...
@section('content')
    ...
    <div class="py-8 bg-gray-50 justify-start items-start w-full border-l">
        <a href="{{ route('userAsset') }}" class="mx-2 sm:mx-10 text-green-600 text-sm font-medium flex">
        ...
        <!-- body -->
        <form action="{{ route('userAssetUpdate', $asset) }}" method="POST" class="mt-6 sm:mx-10 mx-2 font-fredokaRegular">
            @method('put')
            @csrf
            <div class="border-b sm:flex">
                ...
                <input type="text" name="name" id="produk"
                    ...
                    placeholder="Nama aset" value="{{ old('name') ?? $asset->name }}" required>
            </div>
            <div class="border-b mt-3 sm:flex">
                ...
                <textarea name="description" id="deskripsi" cols="30" rows="3"
                    class="outline-none border border-gray-400 p-2 rounded-lg mt-2 mb-4 sm:w-[600px]" placeholder="Deskripsi">{{ old('description') ?? $asset->description }}</textarea>
            </div>
            <div class="border-b mt-3 sm:flex">
            ...
            <div class="border-b mt-3 sm:flex">
                <label for="jumlah" class="sm:w-40 block">Jumlah*</label>
            ...
            <div class="border-b mt-3 sm:flex">
                ...
                <select name="unit_id" id="" class="outline-none border border-gray-400 p-2 rounded-lg mt-2 mb-4"
                    required>
            ...
            <div class="border-b mt-3 sm:flex">
                ...
                <input type="text" id="lokasi"
                    class="sm:w-[600px] outline-none border border-gray-400 p-2 rounded-lg mt-2 mb-4" placeholder="Lokasi"
                    name="location" value="{{ old('location') ?? $asset->location }}" required>
            </div>
            <div class="border-b mt-3 sm:flex">
