        ...
        <div class="border rounded-lg mt-4 py-3 sm:mx-10">
            <div class="flex justify-between px-6">
                <div class="flex gap-2">
                    <p class="text-zinc-700 text-lg font-semibold font-['Fredoka'] leading-9">Semua anggota</p>
                        ...
                        @foreach ($users as $index => $st)
                            <tr class="border-b">
                                ...
                                <td class="py-3 text-start px-3">
                                    <div class="flex justify-start">
                                        <div class="flex">
                                            @if ($st->status != 'Menunggu')
                                                <div
                                                    class="rounded-full bg-lime-50 border items-center inline-flex font-fredokaRegular px-2 mx-auto me-3 {{ $st->status == 'Aktif' ? 'text-green-600 border-green-600' : ($st->status == 'Blok' ? 'text-red-500 border-red-500' : '') }}">
                                                    {{ $st->status }}
                                                </div>
                                                <a value="{{ $st->id }}"
                                                    class="rounded border border-gray-400 items-center flex text-zinc-700 cursor-pointer detail-item">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M16.0184 10.6787L13.3234 7.98371L15.2714 6.03471L17.9654 8.72871L16.0184 10.6787ZM9.07941 17.6247L6.10241 17.8957L6.36641 14.9397L11.9834 9.32271L14.6794 12.0187L9.07941 17.6247ZM19.4034 7.33771L19.4024 7.33671L16.6644 4.59871C15.9234 3.85971 14.6504 3.82471 13.9484 4.52971L4.95241 13.5257C4.62641 13.8507 4.42441 14.2827 4.38241 14.7397L4.00341 18.9097C3.97741 19.2047 4.08241 19.4967 4.29241 19.7067C4.48141 19.8957 4.73641 19.9997 4.99941 19.9997C5.03041 19.9997 5.06041 19.9987 5.09041 19.9957L9.26041 19.6167C9.71841 19.5747 10.1494 19.3737 10.4744 19.0487L19.4714 10.0517C20.1994 9.32171 20.1684 8.1037 19.4034 7.33771Z"
                                                            fill="#231F20" />
                                                        <mask id="mask0_935_2996" style="mask-type:luminance"
                                    ...
                                    @else
                                        <a class="bg-green-600 rounded-lg shadow border border-green-600 justify-center items-center gap-2 inline-flex group p-1 me-2 cursor-pointer accept-user"
                                            value="{{ $st->id }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    fill="#231F20" />
                                                <mask id="mask0_935_4902" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="3" y="3" width="20" height="18">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M10 5C11.103 5 12 5.897 12 7C12 8.103 11.103 9 10 9C8.897 9 8 8.103 8 7C8 5.897 8.897 5 10 5ZM10 11C12.206 11 14 9.206 14 7C14 4.794 12.206 3 10 3C7.794 3 6 4.794 6 7C6 9.206 7.794 11 10 11ZM21.6562 4.2456C21.2392 3.8836 20.6082 3.9266 20.2452 4.3436L18.3792 6.4886L17.7452 5.7796C17.3782 5.3676 16.7462 5.3326 16.3332 5.7016C15.9222 6.0696 15.8862 6.7026 16.2552 7.1136L17.6442 8.6666C17.8342 8.8786 18.1052 8.9996 18.3892 8.9996H18.3962C18.6832 8.9976 18.9562 8.8726 19.1442 8.6566L21.7552 5.6566C22.1172 5.2396 22.0732 4.6076 21.6562 4.2456ZM3 20C3 16.14 6.141 13 10 13C13.859 13 17 16.14 17 20C17 20.552 16.553 21 16 21C15.447 21 15 20.552 15 20C15 17.243 12.757 15 10 15C7.243 15 5 17.243 5 20C5 20.552 4.553 21 4 21C3.447 21 3 20.552 3 20Z"
                                                        fill="white" />
                                                </mask>
                                                <g mask="url(#mask0_935_4902)">
                                                    <rect width="24" height="24" fill="white" />
                                                </g>
                                            </svg>
                                        </a>
                                        <a class="bg-red-500 rounded-lg shadow border border-red-500 justify-center items-center gap-2 inline-flex group p-1 cursor-pointer reject-user"
                                            value="{{ $st->id }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M10 5C11.103 5 12 5.897 12 7C12 8.103 11.103 9 10 9C8.897 9 8 8.103 8 7C8 5.897 8.897 5 10 5ZM10 11C12.206 11 14 9.206 14 7C14 4.794 12.206 3 10 3C7.794 3 6 4.794 6 7C6 9.206 7.794 11 10 11ZM20.4648 7.5L21.1978 6.768C21.6008 6.364 21.6008 5.705 21.1978 5.302C20.7948 4.899 20.1358 4.899 19.7328 5.302L18.9998 6.035L18.2678 5.302C17.8638 4.899 17.2048 4.899 16.8018 5.302C16.3998 5.705 16.3998 6.364 16.8018 6.768L17.5348 7.5L16.8018 8.232C16.3998 8.636 16.3998 9.295 16.8018 9.698C17.2048 10.101 17.8638 10.101 18.2678 9.698L18.9998 8.965L19.7328 9.698C20.1358 10.101 20.7948 10.101 21.1978 9.698C21.6008 9.295 21.6008 8.636 21.1978 8.232L20.4648 7.5ZM3 20C3 16.141 6.141 13 10 13C13.859 13 17 16.141 17 20C17 20.553 16.553 21 16 21C15.447 21 15 20.553 15 20C15 17.243 12.757 15 10 15C7.243 15 5 17.243 5 20C5 20.553 4.553 21 4 21C3.447 21 3 20.553 3 20Z"
                                                    fill="#231F20" />
                                                <mask id="mask0_935_4918" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="3" y="3" width="19" height="18">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M10 5C11.103 5 12 5.897 12 7C12 8.103 11.103 9 10 9C8.897 9 8 8.103 8 7C8 5.897 8.897 5 10 5ZM10 11C12.206 11 14 9.206 14 7C14 4.794 12.206 3 10 3C7.794 3 6 4.794 6 7C6 9.206 7.794 11 10 11ZM20.4648 7.5L21.1978 6.768C21.6008 6.364 21.6008 5.705 21.1978 5.302C20.7948 4.899 20.1358 4.899 19.7328 5.302L18.9998 6.035L18.2678 5.302C17.8638 4.899 17.2048 4.899 16.8018 5.302C16.3998 5.705 16.3998 6.364 16.8018 6.768L17.5348 7.5L16.8018 8.232C16.3998 8.636 16.3998 9.295 16.8018 9.698C17.2048 10.101 17.8638 10.101 18.2678 9.698L18.9998 8.965L19.7328 9.698C20.1358 10.101 20.7948 10.101 21.1978 9.698C21.6008 9.295 21.6008 8.636 21.1978 8.232L20.4648 7.5ZM3 20C3 16.141 6.141 13 10 13C13.859 13 17 16.141 17 20C17 20.553 16.553 21 16 21C15.447 21 15 20.553 15 20C15 17.243 12.757 15 10 15C7.243 15 5 17.243 5 20C5 20.553 4.553 21 4 21C3.447 21 3 20.553 3 20Z"
                                                        fill="white" />
                                                </mask>
                                                <g mask="url(#mask0_935_4918)">
                                                    <rect width="24" height="24" fill="white" />
                                                </g>
                                            </svg>
                                        </a>
    ...
    <div class="h-full w-80 bg-white py-4 px-4 fixed z-20 top-0 right-0 hidden" id="menuFilter">
        ...
        <form action="post" class="mt-6">
            <div class="border-b">
                ...
                <select name="gender" id="gender" class="w-full outline-none border p-2 rounded-lg mt-2 mb-4">
                    <option value="semuaTipe">Semua jenis</option>
                    <option value="laki">Laki - laki</option>
                    <option value="perempuan">Perempuan</option>
                </select>
            </div>
            <div class="border-b mt-4">
                <label for="akun" class="block">Jenis akun</label>
                <select name="akun" id="akun" class="w-full outline-none border p-2 rounded-lg mt-2 mb-4">
                    <option value="semuaTipe">Semua akun</option>
                    <option value="internal">Internal</option>
                    <option value="eksternal">Eksternal</option>
                </select>
            </div>
            <div class="border-b mt-4">
                <label for="status" class="block">Status akun</label>
                <select name="status" id="status" class="w-full outline-none border p-2 rounded-lg mt-2 mb-4">
                    <option value="ta">Semua status</option>
            ...
            <div class="border-b mt-4">
                ...
                <div class="flex">
                    <select name="pelaksanaan id=" pelaksanaan class=" outline-none border p-2 rounded-lg mt-2 mb-4">
                        <option value="brith">Tanggal lahir</option>
