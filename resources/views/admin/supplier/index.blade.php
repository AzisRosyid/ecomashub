    ...
    <div class="py-4 sm:py-8 bg-gray-50 justify-start items-start w-full border-l">
        ...
        <div class="flex mx-4 sm:mx-10 justify-between border-b pb-4">
            ...
            <div class="justify-between hidden lg:flex">
                ...
                <a href="{{ route('adminSupplierCreate') }}"
        ...
        <div class="border rounded-lg mt-4 py-3 sm:mx-10">
            <div class="flex justify-between px-6">
                <div class="flex gap-2">
                    <p class="text-zinc-700 text-lg font-semibold font-fredokaBold leading-9">Semua pemasok</p>
                        ...
                        @foreach ($suppliers as $index => $st)
                            <tr class="border-b">
                                ...
                                <td class="py-3 text-start px-3 min-w-[150px]">
                                    <div class="flex">
                                        <a href="{{ route('adminSupplierEdit', $st) }}"
                                        ...
                                        <form action="{{ route('adminSupplierDestroy', $st) }}" method="POST"
                                            class="px-1">
                                            @method('delete')
                                            @csrf
                                            <button
...
@section('filter')
    ...
    <div class="h-full w-80 bg-white py-4 px-4 fixed z-20 top-0 right-0 hidden" id="menuFilter">
        ...
        <div class="border-b">
            <label for="pemasok" class="block">Tipe pemasok</label>
            <select name="pemasok" id="pemasok" class="w-full outline-none border p-2 rounded-lg mt-2 mb-4">
        ...
        <div class="border-b mt-4">
            <label for="harga" class="block">Dana pemasok</label>
        ...
        <div class="border-b mt-4">
            <label for="kegiatan1" class="block">Tipe pemasok</label>
        ...
        <div class="border-b mt-4">
            <label for="pelaksanaan" class="block">Pelaksanaan pemasok</label>
    ...
    <div id="isiDetail"
        ...
        <div class="font-fredokaRegular pt-4">
            <p class="text-xl font-fredokaBold">Nama Pemasok</p>
