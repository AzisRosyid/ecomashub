...
<section class="bg-gradient-to-br from-green-500 to-green-900 min-h-screen flex items-center justify-center">
    <div class="flex rounded-2xl w-[255px] shadow-lg max-w-3xl bg-white sm:w-[523px]">
        ...
        <div class="w-1/2 bg-white rounded-2xl relative h-[323px]">
            <div class="absolute top-8 mx-4 ">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-1 flex justify-between w-56 rounded-[7px] border-2 border-green-700 p-1">
                        <input id="passwordInput" type="password" name="password" class="outline-none" placeholder="Password"
                            required>
                    ...
                    @if ($errors->any())
                        <p class="text-red-600 font-fredokaRegular text-sm mb-3 mt-3 ms-1">{{ $errors->first() }}</p>
                    @endif
