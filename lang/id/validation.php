...
return [
    ...
    | seperti aturan ukuran. Anda bebas mengedit setiap pesan di sini.
    |
    */
    ...
    'missing_with' => ':attribute harus hilang saat :values hadir.',
    ...
    'present_if' => ':attribute harus hadir saat :other adalah :value.',
    'present_unless' => ':attribute harus hadir kecuali :other ada dalam :values.',
    'present_with' => ':attribute harus hadir saat :values hadir.',
    'present_with_all' => ':attribute harus hadir saat :values hadir.',
    ...
    'required_with' => ':attribute wajib diisi saat :values hadir.',
    'required_with_all' => ':attribute wajib diisi saat :values hadir.',
    'required_without' => ':attribute wajib diisi saat :values tidak hadir.',
    'required_without_all' => ':attribute wajib diisi saat tidak ada satu pun dari :values yang hadir.',
    ...
    | menggunakan konvensi "attribute.rule" untuk memberi nama baris bahasa.
    | Ini memudahkan untuk menentukan pesan bahasa kustom tertentu untuk aturan atribut tertentu.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut digunakan untuk menukar atribut placeholder kami
    | dengan sesuatu yang lebih mudah dibaca oleh pembaca seperti "Alamat Email" daripada "email".
